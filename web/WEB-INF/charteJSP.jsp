            ...
            <form action="" method="POST">
                <div class='row'>
                    ...
                    <div class='col-md-push-1 col-md-10'>
                        ...
                        <div class='margin-charte-titre'>
                            En cliquant sur la bouton "J'accepte" ci-dessous, vous confirmez avoir pris conscience des 
                            différents articles et différentes conditions ci-dessus et adhérez à chacuns et chacunes d'entre
                            eux et elles sans exception.
                        </div>
                    </div>
                </div>
                <div class='row'>
                    <div class='col-md-push-5 col-md-2'>
                        <label for="btValiderCharte"></label>
                        <input class="btn btn-lg bouton-validation" type="submit" value="J'accepte" id="btValiderCharte"/>
                    </div>
                </div>
            </form>
        </div>
